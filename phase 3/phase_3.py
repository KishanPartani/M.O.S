...
def interrupt_routine(rnum):
    ...
    if(rnum == 1):
        ...
        print("CHANNEL 2 STARTED. WRITING TO LINE PRINTER")
        if(len(ofbq) != 0):
            a = ofbq.pop(0)
            for i in range(10):
        ...
        if task == 'IS':
            ...
            if(len(ioq) != 0):
                ...
                if(pcb.LLC < pcb.TLL):
                    ...
                    print("job id", pcb.job_id, "TERMINATED WITH CODE 2")
        ...
        if (TI == 0 or TI == 1):
            if (SI == 0):
                if (PI == 1):
                    ...
                    # Operand Error
                    print("PROGRAM TERMINATED WITH TERMINATE CODE 5")
                    print(rq[0].job_id)
